...
export const MARKETS: Market[] = [
  ...
  },
  {
    ...
    locale: "ko-KR",
    timezone: "Asia/Seoul",
    taxProfileId: "tax_kr_vat",
    taxProfile: "South Korea VAT",
    shippingProfile: "Asia Standard",
    shippingZones: ["asia"],
    shippingOrigin: "Ships from Tokyo",
    estimatedDelivery: "Estimated Delivery: 3–6 Business Days",
  ...
  },
  {
    ...
    taxProfileId: "tax_cn_vat",
    taxProfile: "China VAT",
    shippingProfile: "Asia Standard",
    shippingZones: ["asia"],
    shippingOrigin: "Ships from Tokyo",
    estimatedDelivery: "Estimated Delivery: 3–6 Business Days",
    warehouseId: "wh_tokyo",
    warehouse: "Tokyo Hub",
    priceListId: "pl_cny_default",
    paymentMethods: ["stripe", "alipay"],
    status: "active",
    enabled: true,
    defaultMarket: false,
    displayOrder: 19,
  ...
  },
  {
    ...
    taxProfileId: "tax_ch_vat",
    taxProfile: "Switzerland VAT",
    shippingProfile: "Europe Standard",
    shippingZones: ["europe"],
    shippingOrigin: "Ships from Milan",
    estimatedDelivery: "Estimated Delivery: 2–4 Business Days",
  ...
  // --- SOUTH AMERICA ---
  {
    ...
    taxProfileId: "tax_br",
    taxProfile: "Brazil Tax",
    shippingProfile: "Global Standard",
    shippingZones: ["global"],
    shippingOrigin: "Ships from New York",
    estimatedDelivery: "Estimated Delivery: 5–10 Business Days",
    warehouseId: "wh_ny",
    warehouse: "New York Hub",
    priceListId: "pl_brl_default",
    paymentMethods: ["stripe", "paypal"],
    status: "active",
    enabled: true,
    defaultMarket: false,
  ...
  // --- AFRICA ---
  {
    ...
    taxProfileId: "tax_za_vat",
    taxProfile: "South Africa VAT",
    shippingProfile: "Global Standard",
    shippingZones: ["global"],
    shippingOrigin: "Ships from Dubai",
    estimatedDelivery: "Estimated Delivery: 5–10 Business Days",
