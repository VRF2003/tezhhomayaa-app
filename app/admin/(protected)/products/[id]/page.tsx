            ...
            <div style={{ background: "#ffffff", border: "1px solid #e8e4df", padding: "2rem", borderRadius: "2px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  ...
                  <textarea value={designStory} onChange={e => setDesignStory(e.target.value)} rows={4} style={{ padding: "0.85rem", border: "1px solid #ccc9c4", outline: "none", fontSize: "0.9rem", resize: "vertical" }} />
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  <label style={{ fontSize: "0.75rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#6b6865" }}>Inspiration Story</label>
                  <textarea value={inspirationStory} onChange={e => setInspirationStory(e.target.value)} rows={4} style={{ padding: "0.85rem", border: "1px solid #ccc9c4", outline: "none", fontSize: "0.9rem", resize: "vertical" }} />
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  <label style={{ fontSize: "0.75rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#6b6865" }}>Fabric Details</label>
                  <textarea value={fabricDetails} onChange={e => setFabricDetails(e.target.value)} rows={4} style={{ padding: "0.85rem", border: "1px solid #ccc9c4", outline: "none", fontSize: "0.9rem", resize: "vertical" }} />
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  <label style={{ fontSize: "0.75rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#6b6865" }}>Craftsmanship Details</label>
                  <textarea value={craftsmanshipDetails} onChange={e => setCraftsmanshipDetails(e.target.value)} rows={4} style={{ padding: "0.85rem", border: "1px solid #ccc9c4", outline: "none", fontSize: "0.9rem", resize: "vertical" }} />
                </div>
              </div>
            </div>
