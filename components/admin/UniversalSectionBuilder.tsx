      ...
      <div style={{ padding: "1.5rem" }}>
        ...
        {activeTab === "CONTENT" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div><label style={{ fontSize: "0.75rem", display: "block", marginBottom: "0.5rem" }}>Description</label><textarea value={norm.content.description} onChange={e => update("content", "description", e.target.value)} style={{ width: "100%", padding: "0.8rem", border: "1px solid #ccc9c4", height: "80px", resize: "none" }} /></div>
